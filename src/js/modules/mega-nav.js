// mega-nav.js — Mega navigation con morphing dropdown + mobile slide-over
// Fuente: OSMO mega-nav component
// Auto-detect: [data-menu-wrap] en el DOM
// GSAP nativo de Webflow — esperamos window.gsap (Rocket Loader lo defiere)
...
export async function init() {
  ...
  if (!menuWrap || !navList || !dropWrapper || !dropContainer || !burger) return;
